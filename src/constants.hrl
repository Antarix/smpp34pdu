...
-define(DEFAULT_ESM_CLASS, 0).
-define(DEFAULT_PROTOCOL_ID, 0).
-define(DEFAULT_PRIORITY_FLAG, 1).
-define(DEFAULT_REGISTERED_DELIVERY, 1).
-define(DEFAULT_REPLACE_IF_PRESENT_FLAG, 0).
-define(DEFAULT_DATA_CODING, 0).
-define(DEFAULT_SM_DEFAULT_MSG_ID, 0).
-define(DEFAULT_SM_LENGTH, 0).
